...
// GitHub: https://github.com/OZAT-kz/blog-codes/blob/main/adsense_zero_cls_slot_component_ru.tsx
// ==============================================================================
...
export const ZeroClsAdSlot: React.FC<AdSenseSlotProps> = ({
  ...
  useEffect(() => {
    // Используем IntersectionObserver для отложенной ленивой загрузки
    const observer = new IntersectionObserver(
      ...
      { rootMargin: '200px 0px' } // Начинаем предзагрузку за 200px до экрана
    );
  ...
  useEffect(() => {
    ...
    try {
      // Инициализация пуша в массив adsbygoogle
